...
def load_preprocessed_blob(preprocessed_blob_path):
    ...
    return path_video_samples, path_mixed_spectrograms, path_speech_spectrograms
...
class MyDataset():
    def __init__(self, folds, args, assets):
        self.path_video_samples, self.path_mixed_spectrograms, self.path_speech_spectrograms = \
